...
import { useHistory } from "react-router-dom";
 ...
 export default function Home() {
        ...
        <SideNav/>
         <MDBContainer>
           ...
           <MDBRow>
            ...
            <MDBCol size="3">
      <MDBCard style={{ width: "15rem"},{cursor:"pointer"}} onClick={()=>{history.push("/doctor/getBlog")}}>
        <MDBCardBody>
    ...
    <MDBCol></MDBCol>
    <MDBCol>
      <MDBCard style={{ width: "15rem"},{cursor:"pointer"}} onClick={()=>{history.push("/doctor/meditation")}}>
        <MDBCardBody>
          <MDBCardTitle>Meditation(s)</MDBCardTitle>
          <MDBCardText style={{textAlign:"center"}}>
